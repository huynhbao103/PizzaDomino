...
namespace PizzaDominos.Controllers
{
    public class ToppingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ToppingID,ToppingName,Price")] Topping topping)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ToppingID,ToppingName,Price")] Topping topping)
        {
            if (ModelState.IsValid)
            {
